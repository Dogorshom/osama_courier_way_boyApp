                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            Container(
                              ...
                              child: Text(
                                AppLocalizations.of(context).translate(
                                    'activeOrderPage', 'locationString'),
                                style: buttonBlackTextStyle,
                              ),
                            ),
                            Padding(
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            Container(
                              ...
                              child: Text(
                                AppLocalizations.of(context).translate(
                                    'activeOrderPage', 'customerString'),
                                style: buttonBlackTextStyle,
                              ),
                            ),
                            Padding(
