  ...
  Widget build(BuildContext context) {
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            Container(
                              ...
                              child: Text(
                                AppLocalizations.of(context)
                                    .translate('mapPage', 'locationString'),
                                style: buttonBlackTextStyle,
                              ),
                            ),
                            Padding(
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            Container(
                              ...
                              child: Text(
                                AppLocalizations.of(context)
                                    .translate('mapPage', 'customerString'),
                                style: buttonBlackTextStyle,
                              ),
                            ),
                            Padding(
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            Container(
                              ...
                              child: Text(
                                AppLocalizations.of(context)
                                    .translate('mapPage', 'paymentString'),
                                style: buttonBlackTextStyle,
                              ),
                            ),
                            Padding(
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Text(
                    AppLocalizations.of(context)
                        .translate('mapPage', 'congratulationString'),
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        elevation: 0.0,
        title: Text(
          AppLocalizations.of(context).translate('mapPage', 'mapString'),
          style: headingStyle,
        ),
        centerTitle: true,
        leading: IconButton(
                  ...
                  Container(
                    ...
                    child: SizedBox(
                      ...
                      child: RaisedButton(
                        ...
                        child: Text(
                          AppLocalizations.of(context)
                              .translate('mapPage', 'finishString'),
                          style: wbuttonWhiteTextStyle,
                        ),
                      ),
                    ),
