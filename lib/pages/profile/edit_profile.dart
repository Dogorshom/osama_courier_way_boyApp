                    ...
                    children: <Widget>[
                      Text(
                        AppLocalizations.of(context).translate(
                            'editProfilePage', 'changeFullNameString'),
                        style: headingStyle,
                      ),
                      SizedBox(
                        height: 20.0,
                      ...
                      TextField(
                        ...
                        decoration: InputDecoration(
                          hintText: AppLocalizations.of(context).translate(
                              'editProfilePage', 'enterYourFullNameString'),
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      TextField(
                        ...
                        decoration: InputDecoration(
                          hintText: AppLocalizations.of(context).translate(
                              'editProfilePage', 'oldPasswordString'),
                          hintStyle: greyHeadingStyle,
                        ),
                      ),
                      TextField(
                        ...
                        decoration: InputDecoration(
                          hintText: AppLocalizations.of(context).translate(
                              'editProfilePage', 'newPasswordString'),
                          hintStyle: greyHeadingStyle,
                        ),
                      ),
                      TextField(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      TextField(
                        ...
                        decoration: InputDecoration(
                          hintText: AppLocalizations.of(context).translate(
                              'editProfilePage', 'enterYourEmailString'),
                          hintStyle: greyHeadingStyle,
                        ),
                      ),
                      SizedBox(height: 20.0),
        ...
        actions: <Widget>[
          InkWell(
            ...
            child: Container(
              ...
              child: Text(
                AppLocalizations.of(context)
                    .translate('editProfilePage', 'saveString'),
                style: blueTextStyle,
              ),
            ),
          ),
          ...
          Column(
            ...
            children: <Widget>[
              ...
              InkWell(
                ...
                child: getTile(
                    AppLocalizations.of(context)
                        .translate('editProfilePage', 'fullNameString'),
                    name),
              ),
              // Full Name End
              // Password Start
              InkWell(
                ...
                child: getTile(
                    AppLocalizations.of(context)
                        .translate('editProfilePage', 'passwordString'),
                    '******'),
              ),
              // Password End
              // Phone Start
              InkWell(
                ...
                child: getTile(
                    AppLocalizations.of(context)
                        .translate('editProfilePage', 'phoneString'),
                    phone),
              ),
              // Phone End
              // Email Start
                    ...
                    child: Column(
                      children: <Widget>[
                        Container(
                          ...
                          child: Text(
                            AppLocalizations.of(context).translate(
                                'editProfilePage', 'chooseOptionString'),
